...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolor_csp_x.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='cfg/yolor_csp_x.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='dataset/svhn.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='dataset/hyp.scratch.yaml', help='hyperparameters path')
